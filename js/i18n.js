/* =========================================================
   TEXTE DE / EN – hier kannst du alle Texte bearbeiten
   ========================================================= */
const TEXT = {
  de: {
    ...
    "brand.head":"Vor dem Produkt kam das visuelle Design.",
    "brand.desc":"Ausgewählte Arbeiten aus Branding, Kampagnen und Grafikdesign.",
  ...
  en: {
    ...
    "brand.title":"Visual & Brand Work",
    "brand.head":"Before product, there was visual design.",
    "brand.desc":"Selected work from branding, campaigns and graphic design.",
